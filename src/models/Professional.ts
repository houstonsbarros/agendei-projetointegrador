...
type CheckPasswordCallback = (err?: Error | undefined, match?: boolean) => void;
...
export interface ProfessionalInstance extends Model<Professional, ProfessionalCreationAttributes>, ProfessionalCreationAttributes {
    checkPasswordProfessional: (password: string) => Promise<boolean>;
...
const Professional = sequelize.define<ProfessionalInstance, Professional>('professionals', {
    id: {
        allowNull: false,
        autoIncrement: true,
        primaryKey: true,
...
Professional.prototype.checkPasswordProfessional = function (password: string): Promise<boolean> {
